  ...
  return (
    <div id="services" className="services flex flex-col gap-12 p-6 sm:p-12 md:p-24 bg-[#fbfaf7] text-black w-full relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between border-b border-neutral-900/10 pb-6 gap-4">
        ...
        <span className="font-mono text-[10px] text-neutral-400 tracking-[0.2em] uppercase"></span>
      ...
      <AnimatePresence>
        {selectedService && (
          <div className="fixed inset-0 z-[999] flex items-center justify-center p-4">
            ...
            >
              <button onClick={() => setSelectedService(null)} className="absolute top-4 right-4 z-50 font-mono text-[11px] text-neutral-400 hover:text-white bg-black/50 px-3 py-1 uppercase"></button>
              ...
              <div className="flex-1 p-8 md:p-12 flex flex-col justify-between font-sans">
                ...
                <div className="font-mono text-[10px] text-neutral-500 animate-pulse"></div>
              </div>
            </motion.div>
          </div>
        )}
